...
class Ui_MotorSettings(object):
    def setupUi(self, MotorSettings):
        ...
        self.testdelay_button = QtWidgets.QPushButton(MotorSettings)
        self.testdelay_button.setObjectName("testdelay_button")
        self.gridLayout.addWidget(self.testdelay_button, 0, 3, 1, 1)
